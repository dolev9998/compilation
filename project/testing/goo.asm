...
L_constants:
	...
	; L_constants + 1519:
	db T_pair	; (2)
	dq L_constants + 1510, L_constants + 1
	; L_constants + 1536:
	db T_pair	; (1 2)
	dq L_constants + 1501, L_constants + 1519
...
.L_lambda_simple_arity_check_ok_0002:
	...
	mov rax, PARAM(1)	; param y
	push rax
	mov rax, PARAM(0)	; param x
	push rax
	push 2	; arg count
	mov rax, qword [free_var_1]	; free var cons
